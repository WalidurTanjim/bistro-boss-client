...
const CoverSection = ({ title, sub_title, image}) => {
    return (
        <section className={`coverSection relative w-full h-[500px] md:h-[400px] flex items-center justify-center mt-10`} style={{ backgroundImage: `url(${image})`, backgroundRepeat: 'no-repeat', backgroundSize: "100% 100%"}}>
